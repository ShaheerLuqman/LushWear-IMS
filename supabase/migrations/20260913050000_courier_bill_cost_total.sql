-- Adds cost_total to shopify_courier_bills_with_totals so the Courier Payment Report can
-- show a bill's total cost price alongside its other money fields, same figure the courier
-- bill summary PDF already sums per bill.
